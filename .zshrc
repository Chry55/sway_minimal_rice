...
promptinit
PROMPT='%B$(check_last_exit_code)${vcs_info_msg_0_}%F{12}%2~%f > %b'
...
function check_last_exit_code() {
  ...
  if ! [[ $LAST_EXIT_CODE -eq 0 || $LAST_EXIT_CODE -eq 130 ]]; then
...
krabby random
alias tgpt="tgpt --provider ollama --model 'qwen2.5-coder:7b'"
